...
object VelocityProtocol {
    ...
    fun readGameProfile(buf: PacketByteBuf): GameProfile =
        GameProfile(buf.readUuid(), buf.readString(16), readProperties(buf))

    private fun readProperties(buf: PacketByteBuf): PropertyMap {
        val count = buf.readVarInt()
        val propertiesBuilder = ImmutableMultimap.builder<String, Property>()
        ...
        val propertiesMap = propertiesBuilder.build()
        return PropertyMap(propertiesMap)
    }
}